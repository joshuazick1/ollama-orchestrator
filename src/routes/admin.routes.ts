...
adminRouter.post('/quarantine/:serverId', requireAdmin(), asyncHandler(quarantineServer));
adminRouter.delete('/quarantine/:serverId', requireAdmin(), asyncHandler(unquarantineServer));
