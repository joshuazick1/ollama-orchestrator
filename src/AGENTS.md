...
- [src/circuit-breaker/AGENTS.md](circuit-breaker/AGENTS.md) — Legacy compatibility shim. Circuit-breaker logic was moved into [src/probe/](probe/AGENTS.md); this folder exists only for old test imports.
