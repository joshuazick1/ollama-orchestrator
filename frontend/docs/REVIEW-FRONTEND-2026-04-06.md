...
const serverId =
  lastColonIndex > 0 ? breaker.serverId.substring(0, lastColonIndex) : breaker.serverId;
const model = lastColonIndex > 0 ? breaker.serverId.substring(lastColonIndex + 1) : null;
```
