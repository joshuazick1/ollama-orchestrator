  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="bg-surface rounded-xl border border-surface-border p-6">
        <h3 className="text-lg font-semibold text-text-base mb-6">Server Performance Metrics</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-surface-border">
                <th className="text-left text-text-muted py-3 pl-4 font-medium uppercase text-xs tracking-wider">
                  Server
                </th>
                <th className="text-right text-text-muted py-3 font-medium uppercase text-xs tracking-wider">
                  Requests
                </th>
                <th className="text-right text-text-muted py-3 font-medium uppercase text-xs tracking-wider">
                  Avg Latency
                ...
                <th className="text-right text-text-muted py-3 pr-4 font-medium uppercase text-xs tracking-wider">
                  Score
                </th>
              </tr>
            </thead>
              ...
              {serverPerformance?.map(server => (
                <tr key={server.id} className="hover:bg-surface/30 transition-colors">
                  ...
                  <td className="text-right text-text-base py-4">
                    ...
                    <span className="text-text-subtle text-xs">rpm</span>
                  </td>
