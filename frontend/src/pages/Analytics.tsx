...
export const Analytics = () => {
  ...
  // 30-day historical summary snapshots
  ...
  return (
    <div className="space-y-8 pb-10">
                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      value: formatDurationMs(
                        metricsData.global.streaming.avgStreamingDuration || 0
                      ),
                      color: 'bg-blue-500',
                    },
                    {
                      label: 'Avg Chunk Size',
                      value: `${(metricsData.global.streaming.avgChunkSizeBytes / 1024).toFixed(1)}KB`,
                      color: 'bg-cyan-500',
                    },
                    {
                      label: 'P95 Chunk Gap',
      ...
      {/* Trends Tab - 30-day historical snapshots */}
      {activeTab === 'trends' &&
        (() => {
          const snapshots = summarySnapshotsData?.snapshots ?? [];

          // Build time-series of global request counts + avg latency from snapshots
