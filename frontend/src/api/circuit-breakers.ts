...
export const getCircuitBreakers = async (): Promise<CircuitBreakerResponse> => {
...
export const getEndpointStates = async (
  serverId: string,
  model: string
): Promise<EndpointStatesResponse> => {
  return apiCall(async () => {
    const response = await apiClient.get(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/endpoints`
    );
    return response.data;
  });
};

export const getBreakerForEndpoint = async (
  serverId: string,
  model: string,
  endpoint: string
  ...
  return apiCall(async () => {
    const response = await apiClient.get(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/${encodeURIComponent(endpoint)}`
    );
    return response.data;
  });
};

export const resetBreakerForEndpoint = async (
  serverId: string,
  model: string,
  endpoint: string
  ...
  return apiCall(async () => {
    const response = await apiClient.post(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/${encodeURIComponent(endpoint)}/reset`
    );
    return response.data;
  });
};

export const forceOpenForEndpoint = async (
  serverId: string,
  model: string,
  endpoint: string
): Promise<EndpointMutationResponse> => {
  return apiCall(async () => {
    const response = await apiClient.post(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/${encodeURIComponent(endpoint)}/open`
    );
    return response.data;
  });
};

export const forceCloseForEndpoint = async (
  serverId: string,
  model: string,
  endpoint: string
): Promise<EndpointMutationResponse> => {
  return apiCall(async () => {
    const response = await apiClient.post(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/${encodeURIComponent(endpoint)}/close`
    );
    return response.data;
  });
};

export const forceHalfOpenForEndpoint = async (
  serverId: string,
  model: string,
  endpoint: string
): Promise<EndpointMutationResponse> => {
  return apiCall(async () => {
    const response = await apiClient.post(
      `/circuit-breakers/${encodeURIComponent(serverId)}/${encodeURIComponent(model)}/${encodeURIComponent(endpoint)}/half-open`
    );
    return response.data;
  });
};
